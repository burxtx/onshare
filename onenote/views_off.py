...
def user_page(request, username):
    ...
    return render_to_response('blog/user_page.html', variables)
...
def draft_page(request, username):
    ...
    return render_to_response('blog/draft_page.html', variables)
...
def draft_detail_page(request, blogpost_id):
    ...
    if request.user.id == draft.user_id:
        if request.method == 'GET':
            ...
            return render_to_response('blog/draft_detail.html', variables)
    else:
        raise Http403
...
def blogpost_save_page(request, id=None):
    ...
    return render_to_response('blog/blogpost_save.html', variables)
...
def tag_page(request, tag_name):
    ...
    return render_to_response('blog/tag_page.html', variables)
...
def search_page(request):
    ...
    if request.GET.has_key('ajax'):
        return render_to_response('blog/blogpost_list.html', variables)
    else:
        return render_to_response('blog/search.html', variables)
...
def friends_page(request, username):
    ...
    return render_to_response('blog/friends_page.html', variables)
