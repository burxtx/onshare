...
def product_detail(request, product_id):
    if request.method == 'GET':
        ...
        return render_to_response('wechat/product_detail.html', variables)
...
def product_page(request, username):
    ...
    return render_to_response('wechat/product_page.html', variables)
...
def product_main_page(request):
    ...
    return render_to_response('wechat/product_main_page.html', variables)
